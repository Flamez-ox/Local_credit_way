<!DOCTYPE html>
<html>
  <!-- Mirrored from light.pinsupreme.com/emails_forgot.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 07 May 2023 13:37:02 GMT -->
  <body
  ...
  >
    ...
    >
      ...
      <a href="#" style="color: #a5a5a5; text-decoration: underline"
    ...
    >
      ...
      >
        <h1 style="margin-top: 0px">Hello</h1>
        <div style="color: #636363; font-size: 14px">
          You recently requested to reset your password for your Example Corp
        ...
        <div style="color: #636363; font-size: 14px; margin-top: 30px">
          ...
          30 minutes.<br /><br />Thanks,<br />Example Corp team
        </div>

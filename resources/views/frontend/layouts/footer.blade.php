<footer class="footer-wrap bg-rock">
    <div class="container">
    <img src="{{ asset('frontend/assets/img/footer-shape-1.png') }}" alt="Image" class="footer-shape-one">
    <img src="{{ asset('frontend/assets/img/footer-shape-2.png') }}" alt="Image" class="footer-shape-two">
    ...
    <p> <i class="ri-copyright-line"></i>2021 Raxa. All Rights Reserved By <a href="https://hibootstrap.com/" target="_blank">HiBootstrap</a></p>
    </div>
    </footer>
<header class="header-wrap style1">
    ...
    <li><i class="flaticon-email-1"></i> <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#48202d242427083a293029662b2725"><span class="__cf_email__" data-cfemail="056d6069696a4577647d642b666a68">[email&#160;protected]</span></a></li>
    ...
    <a href="{{ route('user_login') }}" class="btn style1">Sign in</a>
    </div>
    </div>
    </div>
    </nav>

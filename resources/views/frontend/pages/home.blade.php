...
<section class="hero-wrap style1 bg-spring">
    <img src="{{ asset('frontend/assets/img/hero/hero-shape-1.png') }}" alt="Image" class="hero-shape-one">
    <img src="{{ asset('frontend/assets/img/hero/hero-shape-2.png') }}" alt="Image" class="hero-shape-two">
    <img src="{{ asset('frontend/assets/img/hero/hero-shape-3.png') }}" alt="Image" class="hero-shape-three">
    <img src="{{ asset('frontend/assets/img/hero/hero-shape-4.png') }}" alt="Image" class="hero-shape-four md-none">
    ...
    <img src="{{ asset('frontend/assets/img/hero/hero-slide-4.png') }}" alt="Image">
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="col-lg-6">
    <div class="hero-img-wrap">
    <img src="{{ asset('frontend/assets/img/hero/hero-slide-5.png') }}" alt="Image">
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="col-lg-6">
    <div class="hero-img-wrap">
    <img src="{{ asset('frontend/assets/img/hero/hero-slide-6.png') }}" alt="Image">
    </div>
    </div>
    </div>
    </div>
    ...
    <img src="{{ asset('frontend/assets/img/about/about-shape-1.png') }}" alt="Image" class="about-shape-one bounce">
    <img src="{{ asset('frontend/assets/img/about/about-shape-2.png') }}" alt="Image" class="about-shape-two moveHorizontal">
    <img src="{{ asset('frontend/assets/img/about/about-img-1.png') }}" alt="Image" class="about-img">
    </div>
    </div>
    <div class="col-lg-6">
    <div class="about-content">
    <img src="{{ asset('frontend/assets/img/about/about-shape-3.png') }}" alt="Image" class="about-shape-three">
    ...
    <span><img src="{{ asset('frontend/assets/img/feature/feature-icon-4.png') }}" alt="Image"></span>
    ...
    <div class="feature-info">
    <div class="feature-title">
    <span><img src="{{ asset('frontend/assets/img/feature/feature-icon-5.png') }}" alt="Image"></span>
    <h3>Send Money</h3>
    </div>
    <p>Lorem ipsum dolor sit amet dolor alut const slice elit aliquid dolor ametin perfer endis velit sed fuga volup tation sit praising pain.</p>
    </div>
    ...
    <div class="feature-info">
    <div class="feature-title">
    <span><img src="{{ asset('frontend/assets/img/feature/feature-icon-6.png') }}" alt="Image"></span>
    ...
    <img src="{{ asset('frontend/assets/img/security/security-icon-1.png') }}" alt="Image">
    </div>
    ...
    <div class="feature-item">
     <div class="feature-icon">
    <img src="{{ asset('frontend/assets/img/security/security-icon-2.png') }}" alt="Image">
    </div>
    <div class="feature-text">
    ...
    <img src="{{ asset('frontend/assets/img/security/security-shape-1.png') }}" alt="Image" class="security-shape-one">
    <img src="{{ asset('frontend/assets/img/security/security-shape-2.png') }}" alt="Image" class="security-shape-two">
    <img src="{{ asset('frontend/assets/img/security/security-1.png') }}" alt="Image">
    </div>
    </div>
    </div>
    </div>
    ...
    <img src="{{ asset('frontend/assets/img/service/service-icon-1.png') }}" alt="Image">
    </span>
    ...
    <div class="service-card style1">
    <span class="service-icon">
    <img src="{{ asset('frontend/assets/img/service/service-icon-2.png') }}" alt="Image">
    </span>
    ...
    <div class="service-card style1">
    <span class="service-icon">
    <img src="{{ asset('frontend/assets/img/service/service-icon-3.png') }}" alt="Image">
    </span>
    ...
    <div class="service-card style1">
    <span class="service-icon">
    <img src="{{ asset('frontend/assets/img/service/service-icon-4.png') }}" alt="Image">
    </span>
    ...
    <img class="bounce" src="{{ asset('frontend/assets/img/app/app-1.png') }}" alt="Image">
    <img class="app-shape-one" src="{{ asset('frontend/assets/img/app/app-shape-1.png') }}" alt="Image">
    </div>
    </div>
    <div class="col-lg-6">
    ...
    <div class="app-btn">
    <a href="https://www.apple.com/app-store/"><img src="{{ asset('frontend/assets/img/apple-store.png') }}" alt="Image"></a>
    <a href="https://play.google.com/store/apps"><img src="{{ asset('frontend/assets/img/play-store.png') }}" alt=""></a>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="client-info-wrap">
    <div class="client-img">
    <img src="{{ asset('frontend/assets/img/testimonials/client-6.jpg') }}" alt="Image">
    </div>
    </div>
    <div class="quote-icon">
    <i class="flaticon-quote"></i>
    ...
    <h2><img src="{{ asset('frontend/assets/img/pricing-star.png') }}" alt="Image">Basic</h2>
    ...
    <a href="login.html" class="btn style1">Choose Plan</a>
    </div>
    </div>
    </div>
    <div class="col-xl-4 col-lg-6 col-md-6">
    ...
    <div class="pricing-header">
    <h2><img src="{{ asset('frontend/assets/img/pricing-star.png') }}" alt="Image">Standard</h2>
    <div class="pricing-header-tag">
    ...
    <div class="pricing-table style1">
    <div class="pricing-header">
    <h2><img src="{{ asset('frontend/assets/img/pricing-star.png') }}" alt="Image">Premium</h2>
    <div class="pricing-header-tag">
    ...
    <div class="container">
    <img src="{{ asset('frontend/assets/img/cta-shape-1.png') }}" alt="Image" class="cta-shape-one xs-none">
    <img src="{{ asset('frontend/assets/img/cta-shape-2.png') }}" alt="Image" class="cta-shape-two xs-none">
    <div class="row">
    <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
    ...
    <div class="blog-info">
    <h3><a href="blog-details-right-sidebar.html">What Consumer Expect From Commercial Loan</a></h3>
    <ul class="blog-metainfo  list-style">
    <li><i class="flaticon-user-1"></i> <a href="posts-by-author.html">Reanne Carnation</a></li>
    ...
    <div class="blog-info">
    <h3><a href="blog-details-right-sidebar.html">NSI Bank Will Close Their ATM From Tomorrow</a></h3>
    <ul class="blog-metainfo  list-style">
    <li><i class="flaticon-user-1"></i> <a href="posts-by-author.html">Tony Stark</a></li>
    ...
    <div class="blog-info">
    <h3><a href="blog-details-right-sidebar.html">The Fedaral Bank Appoints New Director To Board</a></h3>
    <ul class="blog-metainfo  list-style">
    <li><i class="flaticon-user-1"></i> <a href="posts-by-author.html">Phil Heath</a></li>
